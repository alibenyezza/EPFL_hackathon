...
exports.ShioGlobalStateObjects = exports.ShioPackageId = exports.ShioFastRpcUrl = void 0;
exports.EstimateFee = EstimateFee;
exports.PickShioGlobalStateObject = PickShioGlobalStateObject;
exports.FastGasFeePlugin = FastGasFeePlugin;
exports.ExecuteTransactionBlock = ExecuteTransactionBlock;
exports.ExecuteBundle = ExecuteBundle;
exports.AppendCoinToTip = AppendCoinToTip;
exports.AppendBalanceToTip = AppendBalanceToTip;
const bcs_1 = require("@mysten/bcs");
const suiPackageId = "0x2";
const suiCoinType = "0x2::sui::SUI";
exports.ShioFastRpcUrl = "https://rpc.getshio.com/fast";
exports.ShioPackageId = "0x1889977f0fb56ae730e7bda8e8e32859ce78874458c74910d36121a81a615123";
exports.ShioGlobalStateObjects = [
    {
...
function PickShioGlobalStateObject() {
    return exports.ShioGlobalStateObjects[Math.floor(Math.random() * exports.ShioGlobalStateObjects.length)];
}
async function FastGasFeePlugin(transactionData, options, next) {
    if (!options.client) {
    ...
    transactionData.inputs.push({
        ...
        Pure: {
            ...
            bytes: bcs_1.bcs.u64().serialize(estimatedFee.tipAmount).toBytes(),
        }
    });
...
async function ExecuteTransactionBlock(client, txAndSig, options) {
...
async function ExecuteBundle(client, txAndSig) {
    var args = [];
...
async function AppendCoinToTip(tx, coin, tipAmount) {
...
async function AppendBalanceToTip(tx, balance, tipAmount) {
