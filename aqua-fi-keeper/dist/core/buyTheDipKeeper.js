...
exports.runBuyTheDipStrategy = runBuyTheDipStrategy;
exports.testBuyTheDipStrategy = testBuyTheDipStrategy;
...
// --- LOGIQUE DU KEEPER ---
async function runBuyTheDipStrategy() {
    if (!POSITION_ID) {
    ...
    try {
        ...
        const position = positionObject.data.content.fields;
        ...
        const simTxb = new transactions_1.Transaction();
        simTxb.moveCall({
        ...
        const inspectionResult = await sui_1.suiClient.devInspectTransactionBlock({
            sender: sui_1.keypair.getPublicKey().toSuiAddress(),
...
async function executeRebalance(positionId, newTickLower, newTickUpper) {
...
async function testBuyTheDipStrategy() {
